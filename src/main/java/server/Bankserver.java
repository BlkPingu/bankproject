...
/**
 * Bankserver f�r �berweisungen von einer �berweisebank zu einer anderen
 * @author Dorothea Hubrich
 * @version 1.0
 * @param <IDTyp> Datentyp der ID, unter der sich die �berweisebanken
 *                anmelden
 */
public class Bankserver<IDTyp> {
	...
	/**
	 * Port, auf dem sich Banken anmelden k�nnen
	 */
	public static final int ANMELDEPORT = 7777; //Warten auf Anmeldung am Server
	
	/**
	 * Port, an dem der Server �berweisungen entgegennimmt
	 */
	...
	/**
	 * wartet auf eine eingehende �berweisung und leitet sie an die Zielbank weiter
	 * @throws Exception
	 */
	@SuppressWarnings("unchecked")
	...
	/**
	 * wartet, dass sich zwei Banken anmelden, genau eine �berweisung
	 * ausf�hren und sich dann wieder abmelden
	 * @param args
	 * @throws Exception
	 */
